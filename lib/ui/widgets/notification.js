...
//      console.log(element.getBoundingClientRect());
    ...
    render() {
      return (
      <svg key={id} height="100%" width="100%" viewBox="0 0 20 100" ref={this.refCallback}>
        <Text x="50" y="5" textAnchor="middle" verticalAnchor="start" scaleToFit={false} width={this.state.width}>
          {this.props.notification.value.message}
        </Text>
      </svg>
      );
