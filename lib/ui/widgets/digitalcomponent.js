...
export default class DigitalComponent extends React.Component {
  ...
  render() {
    return (
      <svg height="100%" width="100%" viewBox="0 0 20 35">
        <text x="10" y="6" textAnchor="middle" fontSize="6" dominantBaseline="middle">
          {this.props.label}
        </text>
        <g transform="translate(10, 0)">
          <text textAnchor="middle" y="25" fontSize="26" dominantBaseline="middle">
            {this.state.value.toString()}
          </text>
          <text textAnchor="end" x="40" y="32" fontSize="8" dominantBaseline="baseline">
