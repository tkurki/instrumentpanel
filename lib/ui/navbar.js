...
import SvgHelp24px from '../svg/SvgHelp24px';
import SvgNotificationNone24px from '../svg/SvgNotificationNone24px';
...
export default class IpNavBar extends React.Component {
    ...
    return (
      <nav className="navbar navbar-default" style={{marginBottom: '0px'}}>
        <form className="navbar-form navbar-left" style={navBarStyles}>
          {buttons}
          <div className="btn-group btn navbar-btn pull-right" style={buttonStyle}>
            {heartBeat}
          </div>
        </form>
      </nav>
  ...
  connectedButtons() {
    ...
    var notificationButtonStyle = Object.assign({}, buttonStyle, {backgroundColor: this.props.instrumentPanel.notificationColor}); 
    ...
    var notificationButton = this.props.model.get().settingsVisible ? undefined : (
      <Button className={buttonClass} style={notificationButtonStyle} onClick={this.setPage.bind(this, -1)} disabled={disableButton}>
        <SvgNotificationNone24px x="0" y="0" width="1em" height="1em"/>
      </Button>
    );
      ...
      <span>
        ...
        <div className="btn-group" role="group" style={btnGroupStyle}>
          <Button className={buttonClass + (disableButton ? ' btn-warning' : '')} style={buttonStyle}
            ...
            <SvgHelp24px x="0" y="0" width="1em" height="1em"/>
          </Button>
        </div>
