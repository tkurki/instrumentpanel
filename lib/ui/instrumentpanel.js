...
InstrumentPanel.prototype.getLayout = function(page) {
  ...
  if (page === -1) {
    return this.notificationPage[0].layout;
  }
...
InstrumentPanel.prototype.getWidgets = function(page) {
  ...
  if (page === -1) {
    return this.notificationPage[0].widgets;
  }
  if (typeof this.pages[page] === 'undefined') {
    this.pages[page] = newPage();
  }
...
InstrumentPanel.prototype.handlePossiblyNewSource = function(newSource) {
  ...
  var handlePage = (notification) ? -1 : this.currentPage;

  if ( this.currentPage !== -1 || notification ) {
...
InstrumentPanel.prototype.getActiveWidgets = function() {
  var activePage = (this.currentPage === -1)? this.notificationPage[0] : this.pages[this.currentPage];
...
InstrumentPanel.prototype.setNotificationLevel = function(newLevel) {
  var widgets = this.notificationPage[0].widgets;
  ...
  newLevel = maxWidget.notification.value.level
  if (newLevel !== this.notificationLevel){
    this.notificationLevel = newLevel;
